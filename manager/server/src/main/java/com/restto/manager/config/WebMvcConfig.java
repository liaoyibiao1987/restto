...
import com.restto.manager.security.PermissionInterceptor;
import com.restto.manager.security.TokenInterceptor;
 ...
 * {@link com.restto.manager.security.UserContext}。显式 {@code order()} 防止后续重构打乱顺序。
 */
@Configuration
