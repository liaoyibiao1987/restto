...
restto 客户端主程序：**agent 友好的 CLI** + **常驻 daemon**。所有备份能力由
...
restto-client tool run <name> [参数来源]      # 以 JSON 参数运行工具

# 兼容旧命令
restto-client backup-file   --path P --dest D
restto-client backup-mysql  --host .. --user .. --password .. --database .. --dest ..
restto-client run-module <name> --args '<json>'
```
